    ...
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = response.data.filter(
          (product) => product.category && product.category.name === "Motion Control"
        );
  ...
  return (
    <div className="bg-gradient-to-r from-black via-gray-900 to-gray-700 min-h-screen py-6">
      <div className="container mx-auto px-6">
        <div className="mb-8">
          <img
            src="https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1716309650-51CnU0Yb75L.jpg?crop=1xw:1.00xh;center,top&resize=980:*"
            alt="Motion Control Shoes"
