...
const sampleProducts = [
  { image: "https://th.bing.com/th/id/OIP.3GFMzVfn8K46TJSq_xfiRQHaFg?rs=1&pid=ImgDetMain", name: "Product 1", price: "₱99.99" },
   ...
   return (
      <div className="bg-gradient-to-r from-black via-gray-900 to-gray-700 min-h-screen py-6">
        <div className="container mx-auto px-6">
          ...
          <div className="mb-8">
            <img
              src="https://th.bing.com/th/id/OIP.3GFMzVfn8K46TJSq_xfiRQHaFg?rs=1&pid=ImgDetMain"
              alt=""
